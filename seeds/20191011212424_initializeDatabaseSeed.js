  ...
  return knex('USER')
    ...
    .then(function() {
      return knex('QUESTION').insert([
        ...
        {
          ID: 13,
          TEXT: 'Ce tip de incaltari trebuie folosita la locul de munca?'
        },
        {
          ID: 14,
          TEXT:
            'Ce trebuie sa facem daca vedem cabluri trase prin mijlocul camerei?'
        },
        ...
        { ID: 16, TEXT: 'Pe ce culoare a semaforului trecem strada?' },
        {
          ID: 17,
          TEXT:
            'Daca semaforul e rosu si nu vine nicio masina din ambele sensuri, traversam?'
        },
    ...
    .then(function() {
      return knex('ANSWER').insert([
        ...
        {
          ID: 12,
          TEXT: 'Pe tavan cu un indicator verde',
          IS_CORRECT: true,
          ID_QUESTION: 4
        },
        {
          ID: 13,
          TEXT: 'Cu un girofar rosu de-asupra iesirii',
          IS_CORRECT: true,
          ID_QUESTION: 4
        },
        {
          ID: 14,
          TEXT: 'Pe rand in functie de cine e mai aproape de iesire',
          IS_CORRECT: true,
          ID_QUESTION: 5
        },
        ...
        {
          ID: 16,
          TEXT: 'Femeile in varsta si copiii',
          IS_CORRECT: false,
          ID_QUESTION: 5
        },
        {
          ID: 17,
          TEXT: 'Urgenta este urgenta',
          IS_CORRECT: true,
          ID_QUESTION: 6
        },
        {
          ID: 18,
          TEXT: 'Urgenta nu este urgenta',
          IS_CORRECT: false,
          ID_QUESTION: 6
        },
        {
          ID: 19,
          TEXT: 'Cand te trece la baie',
          IS_CORRECT: false,
          ID_QUESTION: 6
        },
        ...
        {
          ID: 39,
          TEXT: 'Anuntam conducerea despre problema',
          IS_CORRECT: true,
          ID_QUESTION: 14
        },
