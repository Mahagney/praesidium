...
router.get('/course/:courseId', authenticateToken, employeeTypesController.getEmployeeTypesForCourse);

router.delete('/:employeeTypeId', authenticateToken, employeeTypesController.deleteEmployeeType);
